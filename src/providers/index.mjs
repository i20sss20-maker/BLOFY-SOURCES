...
export const providerDefinitions = [
  ...
  { id:'open-arabic-films', name:'Open films · Arabic localized', kind:'VOD', sync:syncOpenArabicFilms, enabled:()=>envBool('ENABLE_OPEN_ARABIC_FILMS', true), deferred:true, rights:'Curated reusable films only; foreign titles require a verified Arabic subtitle track and machine-readable open licence.' },
