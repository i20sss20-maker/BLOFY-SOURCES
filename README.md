...
- تعطيل وتفعيل الحساب.
- تحديد عدد الاتصالات، مع `active_cons` فعلي ورفض HTTP 429 عند تجاوز الحد على مسارات التشغيل التي تمر عبر BLOFY proxy.
- لوحة المشتركين تعرض `النشط / الحد` وتصدّر العدد الحالي في CSV.
- مسارات التشغيل القديمة التي تنتهي بـ 302 إلى مصدر خارجي لا تُحسب كجلسة طويلة بعد التحويل؛ الإنفاذ الصارم حاليًا يشمل البث المار داخل BLOFY، ومنها Xtream Upstream المرخّص.
